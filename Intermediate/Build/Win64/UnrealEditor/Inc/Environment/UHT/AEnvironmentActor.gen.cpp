...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AEnvironmentActor_Statics::NewProp_MeshComponent = { "MeshComponent", nullptr, (EPropertyFlags)0x0020080000080009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AEnvironmentActor, MeshComponent), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MeshComponent_MetaData), NewProp_MeshComponent_MetaData) };
...
UObject* (*const Z_Construct_UClass_AEnvironmentActor_Statics::DependentSingletons[])() = {
	(UObject* (*)())Z_Construct_UClass_AAEnvActor,
